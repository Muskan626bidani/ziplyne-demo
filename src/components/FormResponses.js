...
function DisplayInfo() {
  ...
  async function getInfo() {
    ...
    const demo_data = collection(db, "studentAmbassador");
    var amb_doc = await getDocs(demo_data);
